...
/*  appearance font: see http://freedesktop.org/software/fontconfig/fontconfig-user.html
 *  static char *font = "Libertinus
 *  Mono:pixelsize=32:antialias=true:autohint=true";
 */

static char *font = "CaskaydiaCove Nerd Font Mono:pixelsize=64:antialias=true:autohint=true";
...
/* word delimiter string: L" "; More advanced example: L" `'\"()[]{}"; */
...
/* Force mouse select/shortcuts while mask is active (when MODE_MOUSE is set).
   Note that if you want to use ShiftMask with selmasks, 
   set this to an other modifier, set to 0 to not use it. */
...
/* If you want keys other than the X11 function keys (0xFD00 - 0xFFFF) to be
...
/* This is the huge key array which defines all compatibility to the Linux world. Choose wisely. */
static Key key[] = {
